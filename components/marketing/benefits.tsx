      ...
      >
        ...
        <div className="flex-1 space-y-6">
          <div className="space-y-4">
            ...
            <h2 className="text-h2 font-semibold tracking-tight text-white leading-tight">
              {title}
            </h2>
            <p className="text-body text-zinc-400 max-w-prose">
              {description}
            </p>
          </div>
        </div>
  ...
  return (
    <section className="mx-auto max-w-6xl px-4" id="features">
      ...
      <div className="py-24 text-center space-y-4">
        <h2 className="text-sm-fluid font-bold text-orange-500 uppercase tracking-[0.2em]">THE SENDCAT WAY</h2>
        <h3 className="text-h2 font-semibold text-white tracking-tight leading-tight">

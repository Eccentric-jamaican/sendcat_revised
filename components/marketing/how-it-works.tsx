...
export function HowItWorks() {
  ...
  return (
    <section ref={sectionRef} className="mx-auto max-w-6xl px-5 sm:px-6 py-20 md:py-28" id="how-it-works">
      {/* Header */}
      <div className="mb-12 md:mb-16 max-w-3xl space-y-3">
        ...
        <p className="text-body text-zinc-400">
          See every step from query to delivery with total cost clarity.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-8 md:gap-10 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-3">
            <h3 className="text-sm-fluid font-bold uppercase tracking-[0.15em] text-orange-500">Step 1: Ask SendCat</h3>
            <p className="text-sm-fluid text-zinc-400 leading-relaxed max-w-[30ch]">
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-3">
            <h3 className="text-sm-fluid font-bold uppercase tracking-[0.15em] text-orange-500">Step 2: See Total Cost</h3>
            <p className="text-sm-fluid text-zinc-400 leading-relaxed max-w-[30ch]">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <h3 className="text-sm-fluid font-bold uppercase tracking-[0.15em] text-orange-500">Step 3: We Ship It</h3>
            <p className="text-sm-fluid text-zinc-400 leading-relaxed max-w-[30ch]">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <h3 className="text-sm-fluid font-bold uppercase tracking-[0.15em] text-orange-500">Step 4: Delivery</h3>
            <p className="text-sm-fluid text-zinc-400 leading-relaxed max-w-[30ch]">
